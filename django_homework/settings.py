...
SECRET_KEY = 'django-insecure-5)6&pxymh**5q$(bk4pwash_4g#r0@j)bz-omd@3y!w29q7-ur'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',
        'PORT': '5433',  # for some reason 5432 was not working
    }
}
...
EMAIL_HOST_PASSWORD = env('YANDEX_APP_PASSWORD')
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
